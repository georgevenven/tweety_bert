...
plot_umap_projection(
    model=model, 
    device=device, 
    data_dirs=["/media/george-vengrovski/Extreme SSD/sham lesioned birds/USA5271_group_1",
                "/media/george-vengrovski/Extreme SSD/sham lesioned birds/USA5271_group_2",
                "/media/george-vengrovski/Extreme SSD/sham lesioned birds/USA5271_group_3",
                "/media/george-vengrovski/Extreme SSD/sham lesioned birds/USA5271_group_4"],
    samples=1e6, 
...
plot_umap_projection(
    model=model, 
    device=device, 
    data_dirs=["/media/george-vengrovski/Extreme SSD/sham lesioned birds/USA5283_group_1",
                "/media/george-vengrovski/Extreme SSD/sham lesioned birds/USA5283_group_2",
                "/media/george-vengrovski/Extreme SSD/sham lesioned birds/USA5283_group_3",
                "/media/george-vengrovski/Extreme SSD/sham lesioned birds/USA5283_group_4"],
    samples=1e6, 
    category_colors_file="/home/george-vengrovski/Downloads/category_colors_llb3.pkl", 
    layer_index=-2, 
    dict_key="attention_output", 
