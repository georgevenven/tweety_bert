...
## This should be CPU so that we are never limited by GPU memory ## <-- change this if your system memory is less than VRAM or you have a ton of VRAM
...
plot_umap_projection(
    model=model, 
    device=device, 
    data_dirs=["/media/george-vengrovski/Extreme SSD/sham lesioned birds/USA5271_group_1", "/media/george-vengrovski/Extreme SSD/sham lesioned birds/USA5271_group_2", "/media/george-vengrovski/Extreme SSD/sham lesioned birds/USA5271_group_3", "/media/george-vengrovski/Extreme SSD/sham lesioned birds/USA5271_group_4"],
    samples=1e4, 
