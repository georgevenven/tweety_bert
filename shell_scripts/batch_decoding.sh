...
MAIN_WAV_FOLDER="/media/george-vengrovski/Desk SSD/TweetyBERT/embedding_songs"
...
process_bird() {
    ...
    python src/spectogram_generator.py --src_dir "$WAV_FOLDER" --dst_dir "$UMAP_FILES" --song_detection_json_path "$SONG_DETECTION_JSON_PATH" --generate_random_files_number 7500 --single_threaded false
